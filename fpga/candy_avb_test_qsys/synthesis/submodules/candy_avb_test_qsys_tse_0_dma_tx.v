// candy_avb_test_qsys_tse_0_dma_tx.v
...
`timescale 1 ps / 1 ps
module candy_avb_test_qsys_tse_0_dma_tx (
		...
		output wire [3:0]  descriptor_read_master_burstcount,          //                        .burstcount
	...
	altera_msgdma_prefetcher #(
		.ENHANCED_FEATURES          (0),
		.ENABLE_READ_BURST          (1),
		.MAX_READ_BURST_COUNT       (8),
		.MAX_READ_BURST_COUNT_WIDTH (4),
		.DATA_WIDTH                 (32),
		.DATA_BYTEENABLE_WIDTH      (4),
		.DESCRIPTOR_WIDTH           (128),
		.ADDRESS_WIDTH              (25),
		.RESPONSE_FIFO_DEPTH        (512),
		.RESPONSE_FIFO_DEPTH_LOG2   (9)
	) prefetcher_internal (
		.clk                         (clock_clk),                                                    //                              Clock.clk
		.reset                       (~reset_n_reset_n),                                             //                        Clock_reset.reset
		...
		.mm_read_burstcount          (descriptor_read_master_burstcount),                            //                                   .burstcount
